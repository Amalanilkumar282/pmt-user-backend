...
{
    public class EditIssueCommandHandler : IRequestHandler<EditIssueCommand, ApiResponse<Guid>>
    {
        private readonly IIssueRepository _issueRepository;
        private readonly IMapper _mapper;

        public EditIssueCommandHandler(IIssueRepository issueRepository, IMapper mapper)
        {
            _issueRepository = issueRepository;
            _mapper = mapper;
        }

        public async Task<ApiResponse<Guid>> Handle(EditIssueCommand request, CancellationToken cancellationToken)
        {
